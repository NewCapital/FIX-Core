Contributing to FIX Core
============================

The FIX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FIX Core project, and is not to be
confused with overall FIX Network Protocol consensus changes.

Whether a pull request is merged into FIX Core rests with the project merge
...
Patches that change FIX consensus rules are considerably more involved than
...
Where a patch set proposes to change the FIX consensus, it must have been
...
The project leader is the release manager for each FIX Core release.
