...
This means one can have an always-on fixd instance running, and another local fixd/fix-qt instance which connects to this node and receives blocks from it.
