...
RESOURCES += src/qt/fix.qrc src/qt/fix_locale.qrc
TRANSLATIONS += src/qt/locale/fix_bg.ts \
                src/qt/locale/fix_de.ts \
                src/qt/locale/fix_en.ts \
                src/qt/locale/fix_es.ts \
                src/qt/locale/fix_fi.ts \
                src/qt/locale/fix_fr.ts \
                src/qt/locale/fix_it.ts \
                src/qt/locale/fix_ja.ts \
                src/qt/locale/fix_pl.ts \
                src/qt/locale/fix_pt.ts \
                src/qt/locale/fix_ru.ts \
                src/qt/locale/fix_sk.ts \
                src/qt/locale/fix_sv.ts \
                src/qt/locale/fix_vi.ts \
                src/qt/locale/fix_zh_CN.ts \
                src/qt/locale/fix_zh_TW.ts
