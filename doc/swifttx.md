...
This mechanism has been integrated into Bitcore-Node-FIX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/FIX-Project/insight-api-fix#web-socket-api](https://github.com/FIX-Project/insight-api-fix#web-socket-api) 
* API: [https://github.com/FIX-Project/insight-api-fix#swifttx-transactions](https://github.com/FIX-Project/insight-api-fix#swifttx-transactions) 
...
By default, the FIX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FIX Core daemon:
