...
In order to support loading of multiple wallets in fix-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fix.cpp.
...
Changes to fix.cpp
----------------------
fix.cpp is the entry point into fix-qt, and as such, will require some minor modifications to provide hooks for
