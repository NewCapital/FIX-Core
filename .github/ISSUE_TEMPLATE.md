...
This issue tracker is only for technical issues related to FIX Core.
General FIX questions and/or support requests and are best directed to the [FIX Discord](https://discordapp.com/invite/zZbnYKV).
...
### What version of FIX Core are you using?
