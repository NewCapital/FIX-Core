...
#ifndef FIX_ZFIXTRACKER_H
#define FIX_ZFIXTRACKER_H
...
public:
    CzFIXTracker(std::string strWalletFile);
    ~CzFIXTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzFIXWallet* zFIXWallet = NULL);
