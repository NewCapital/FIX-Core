...
#ifndef FIX_ZFIXWALLET_H
#define FIX_ZFIXWALLET_H
...
public:
    CzFIXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZFIX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZFIX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
