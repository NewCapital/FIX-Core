...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    UniValue zfixObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zfixObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zfixObj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.push_back(Pair("zFIXsupply", zfixObj));
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        ...
        /*    "  \"zFIXsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zFIX denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zFIX denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zFIX denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zFIX denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zFIX denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zFIX denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zFIX denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zFIX denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zFIX denominations\n"
            "  }\n"
            "}\n"
           */
            "\nResult (for verbose=false):\n"
