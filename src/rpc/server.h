...
extern UniValue setzfixseed(const UniValue& params, bool fHelp);
extern UniValue getzfixseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzfix(const UniValue& params, bool fHelp);
extern UniValue dzfixstate(const UniValue& params, bool fHelp);
