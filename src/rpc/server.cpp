...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FIX features */
        {"fix", "masternode", &masternode, true, true, false},
        {"fix", "listmasternodes", &listmasternodes, true, true, false},
        {"fix", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fix", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fix", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fix", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fix", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fix", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fix", "masternodedebug", &masternodedebug, true, true, false},
        {"fix", "startmasternode", &startmasternode, true, true, false},
        {"fix", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fix", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fix", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fix", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fix", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fix", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fix", "mnbudget", &mnbudget, true, true, false},
        {"fix", "preparebudget", &preparebudget, true, true, false},
        {"fix", "submitbudget", &submitbudget, true, true, false},
        {"fix", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fix", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fix", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fix", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fix", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fix", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fix", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fix", "checkbudgets", &checkbudgets, true, true, false},
        {"fix", "mnsync", &mnsync, true, true, false},
        {"fix", "spork", &spork, true, true, false},
        {"fix", "getpoolinfo", &getpoolinfo, true, true, false},
...
/*
        ...
        {"zerocoin", "getzfixseed", &getzfixseed, false, false, true},
        {"zerocoin", "setzfixseed", &setzfixseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzfix", &searchdzfix, false, false, true},
        {"zerocoin", "dzfixstate", &dzfixstate, false, false, true}
*/
...
{
    return "> fix-cli " + methodname + " " + args + "\n";
}
