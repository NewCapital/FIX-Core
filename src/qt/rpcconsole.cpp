                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFIXPathCustom = GetArg("-zfixbackuppath", "");
    ...
    if(!strzFIXPathCustom.empty()) {
        ui->wallet_customzfixbackuppath->setText(QString::fromStdString(strzFIXPathCustom));
        ui->wallet_customzfixbackuppath_label->setVisible(true);
        ui->wallet_customzfixbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFIXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the FIX RPC console.") + "<br>" +
