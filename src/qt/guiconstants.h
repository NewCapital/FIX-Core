...
/* FIX GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "FIX"
#define QAPP_ORG_DOMAIN "fix.network"
#define QAPP_APP_NAME_DEFAULT "FIX-Qt"
#define QAPP_APP_NAME_TESTNET "FIX-Qt-testnet"
