...
#   c) node1 mines 32 blocks, so now node 0 has 60001fix, node 1 has 4250fix, node2 has none.
#   d) node0 sends 601 fix to node2, in two transactions (301 fix, then 300 fix).
